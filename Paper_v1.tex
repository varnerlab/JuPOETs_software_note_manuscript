...
The execution time (wall-clock) for JuPOETs and Octave-POETs was measured for 10 independent trials for the suite of test problems.
The same cooling, neighbor, acceptance, search and objective logic was employed between the implementations, with all other parameters held constant.
For each test function, the search domain was partitioned into 10 segments, where initial parameter guesses were drawn from each partition.
