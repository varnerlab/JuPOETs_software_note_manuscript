...
We demonstrated JuPOETs on a suite of multiobjective problems, including test functions with parameter bounds and system constraints as well as identification of a proof-of-concept biochemical model.
...
lead to robust model performance. Multiobjective optimization is a class of ensemble generation techniques that naturally balances conflicting training data.
...
using a variety of techniques without alterating JuPOETs. Finally, JuPOETs has the potential for widespread use due to the high level syntax and distribution tools native to Julia. 
