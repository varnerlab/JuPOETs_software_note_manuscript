...
for index in collect(1:number_of_subdivisions)
  ...
  (EC,PC,RA) = estimate_ensemble(objective_function,neighbor_function,acceptance_probability_function,initial_state_array;rank_cutoff=4,maximum_number_of_iterations=10)
