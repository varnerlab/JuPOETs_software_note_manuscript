...
# load the data -
ec_array = readdlm("./ec_array_schaffer.dat")
pc_array = readdlm("./pc_array_schaffer.dat")
...
idx_rank_1 = find(rank_array.>=1.0)
semilogx(transpose(1:length(idx_rank_1)),pc_array[1,idx_rank_1],".",color="0.75")

# Plot rank 0 in black -
idx_rank_0 = find(rank_array.==0.0)
semilogx(transpose(1:length(idx_rank_0)),pc_array[1,idx_rank_0],"k.")
